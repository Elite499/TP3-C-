...
void Programme::ajoutProduit(int nbr_produits){
    ...
    for(int i = 0 ; i < nbr_produits ; i++){
        ...
        m_magasin.addProductToStore(titre, description, prix , quantite);
        writeProducts();
    }
}
...
void Programme::choixGestionUtilisateurs(char help){
    ...
    if(help == '1'){
        ...
        m_magasin.newClient(prenom,nom);
        writeClients();
    }
                    ...
                    if(client_exist){
                        ...
                        if(tmp != '4'){
                            ...
                            if (tmp == '1') {
                                ...
                                m_magasin.delProductClient(titre, prenom, nom);
                    ...
                    if(client_exist){
                        ...
                        if(tmp != '4'){
                            ...
                            if (tmp == '1') {
                                ...
                                m_magasin.delProductClient(titre, id);
                                std::cout << "Produit supprimer du panier du clien\n";
                            }
                            else if (tmp == '3'){
...
void Programme::choixGestionCommandes(char help){
    ...
    if(help == '1'){
        ...
        if(aide == '1'){
            ...
            if(m_magasin.clientExist(prenom, nom)){
                m_magasin.validCommande(prenom,nom);
...
// si 0 c est faulse 1 c est vrais
        ...
        for(auto& i:m_magasin.getOrders())
            m_magasin.showCommandesClient( i.getClient()->getPrenom(), i.getClient()->getNom());
        ...
        if(aide == '1'){
            ...
            int id;
            std::cin >> id ;
            m_magasin.showCommandesClient(id);
        }
            ...
            std::string nom;
            std::getline(std::cin,nom);
            m_magasin.showCommandesClient(prenom,nom);
        }
    }
}
